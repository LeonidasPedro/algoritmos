...
# deixar um espaço após os dois pontos e um espaço após o "R$". O valor deverá ser apresentado com 
...
def peagarValores (lines)
	lines.split(' ').map(&:to_f)
end

code, quantity, value = peagarValores(item)
code2, quantity2, value2 = peagarValores(item2)
total = quantity * value  + quantity2 * value2
